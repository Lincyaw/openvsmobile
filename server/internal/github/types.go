...
// HostError annotates a wrapped error with the GitHub host that produced it,
// so log messages and OAuth error mapping can disambiguate enterprise vs.
// public GitHub failures.
